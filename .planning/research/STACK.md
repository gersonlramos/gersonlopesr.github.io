...
**Domain:** Personal portfolio website (Data Scientist / Data Engineer, hybrid), static, hosted on GitHub Pages
...
# Add integrations
pnpm astro add mdx
pnpm astro add tailwind      # wires up @tailwindcss/vite for Tailwind v4
pnpm astro add sitemap

# Supporting libraries
pnpm add lucide-astro
pnpm add vega vega-lite vega-embed   # only if an interactive chart island is planned
...
quarto render notebooks/churn-model-analysis.ipynb --to html --output-dir static-exports
```
...
**If the user is comfortable with (or is delegating to an AI agent) light front-end work in Markdown/MDX + Tailwind:**
...
**If the user wants to author every case study as an executed Python/R notebook and minimize front-end involvement entirely:**
...
**If minimizing tooling/maintenance is the overriding priority (no Node install, no CI config to babysit):**
...
**When the v2 blog (currently out of scope) is added later:**
...
---
*Stack research for: Personal data science/data engineering portfolio, static, GitHub Pages*
*Researched: 2026-07-03*
